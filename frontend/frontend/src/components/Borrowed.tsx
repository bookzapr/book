...
import { MedicalEquimentInterface } from "../models/IMedicalEquipment";
  ...
  // กดเลือกคอมโบไม่ได้
    ...
    function submit() {
      let data = {
        ...
        DoctorID:  borrow.DoctorID,
  
        WorkplaceID:  borrow.WorkplaceID,
